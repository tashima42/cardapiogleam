...
// build/dev/javascript/cardapiogleam/cardapiogleam.mjs
...
function top_card(title, description) {
  return div(
    toList([class$("card bg-base-100 w-60 shadow-md h-40")]),
    toList([
      div(
        toList([class$("card-body")]),
        toList([
          h2(
            toList([class$("card-title text-primary bold")]),
            toList([text(title)])
          ),
          div(
            toList([class$("card-actions justify-end")]),
            toList([p(toList([]), toList([text(description)]))])
          )
        ])
      )
    ])
...
function bottom_card(title, description) {
  return div(
    toList([class$("card bg-neutral w-96 shadow-xl")]),
    toList([
      div(
        toList([class$("card-body")]),
        toList([
          h2(
            toList([class$("card-title text-primary")]),
            toList([text(title)])
          ),
          div(
            toList([class$("card-actions justify-end")]),
  ...
  return div(
    ...
    toList([
      div(
        toList([
          class$(
            "navbar bg-base-100 sticky top-0 z-50 border-solid border-b-2 border-primary"
          )
        ]),
        toList([
          button(
            toList([class$("btn btn-ghost text-xl")]),
            toList([text("MOMMY's Cozinha caseira")])
          )
        ])
      ),
      div(
        ...
        toList([
          h3(
            toList([
              class$("text-2xl font-semibold text-center mt-4")
            ]),
            toList([text("Card\xE1pio da semana")])
          ),
          div(
            toList([
              class$(
                "flex flex-row overflow-auto p-5 justify-center"
              )
            ]),
            toList([
              top_card("#1", "Arroz, feij\xE3o, carne, salada e suco"),
              top_card("#1", "Arroz, feij\xE3o, carne, salada e suco"),
              top_card("#1", "Arroz, feij\xE3o, carne, salada e suco"),
              top_card("#1", "Arroz, feij\xE3o, carne, salada e suco"),
              top_card("#1", "Arroz, feij\xE3o, carne, salada e suco")
      ...
      div(
        toList([class$("flex justify-center w-100")]),
        toList([
          div(
            toList([
              class$(
                "products grid grid-cols-2 justify-items-center gap-6 w-3/5"
              )
            ]),
            toList([
              bottom_card("Kit semanal (R$ 60,00)", "Card\xE1pio da semana"),
              bottom_card("Kit semanal (R$ 60,00)", "Card\xE1pio da semana"),
              bottom_card("Kit semanal (R$ 60,00)", "Card\xE1pio da semana"),
              bottom_card("Kit semanal (R$ 60,00)", "Card\xE1pio da semana"),
              bottom_card("Kit semanal (R$ 60,00)", "Card\xE1pio da semana"),
